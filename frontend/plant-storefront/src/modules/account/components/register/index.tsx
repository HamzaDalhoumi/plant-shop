    ...
    >
      ...
      <div className="bg-white rounded-2xl border border-brand-beigeDark/30 shadow-sm p-6 sm:p-8">
        <form className="space-y-4" action={formAction}>
          ...
          <div>
            <label className="block text-sm font-medium text-brand-oliveDark mb-2">
              {t("phone")} <span className="text-brand-oliveDark/40">({t("optional")})</span>
            </label>
            <input
              name="phone"
              type="tel"
          ...
          <div>
            ...
            />
            <p className="mt-1.5 text-xs text-brand-oliveDark/50">
              {t("passwordHint")}
            </p>
          </div>

          {/* Terms */}
          <div className="bg-brand-cream/50 rounded-xl p-4 text-xs text-brand-oliveDark/70 leading-relaxed">
            {t("termsText")}{" "}
            <LocalizedClientLink
